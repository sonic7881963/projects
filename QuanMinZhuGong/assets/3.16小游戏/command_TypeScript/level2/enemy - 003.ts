...
@ccclass
export default class enemy_3 extends cc.Component {
    ...
    onCollisionExit(other) {
       ...
       if( main_1.main_hp <= 0) {
        ...
        other.node.children[0].setContentSize( main_1.main_hp, 19);
       }
    ...
    update (dt) {
        ...
        let node1 = cc.find("Canvas/bj/kuan/小鬼2");
        if (this.count == 0) {
